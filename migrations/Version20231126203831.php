 ...
 */
final class Version20231126203831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, CHANGE reset_token reset_token VARCHAR(500) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles VARCHAR(500) NOT NULL, CHANGE reset_token reset_token VARCHAR(500) DEFAULT NULL');
    }
}
