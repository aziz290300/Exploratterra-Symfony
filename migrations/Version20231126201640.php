 ...
 */
final class Version20231126201640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles reset_token VARCHAR(500) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE reset_token roles VARCHAR(500) NOT NULL');
    }
}
